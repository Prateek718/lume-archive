// Beard detail — Phase 4B placeholder. Replaced with the real screen in the
// next phase.
    ...
    <>
      ...
      <SafeAreaView style={{ flex: 1, backgroundColor: Palette.bg }}>
        ...
        <View style={{ flex: 1, paddingHorizontal: 32, justifyContent: 'center' }}>
          <ChapterLabel>Part three · beard</ChapterLabel>
          ...
          <Body serif size={14} style={{ fontStyle: 'italic' }}>
            Beard detail — shape, routine, barber notes — lands in the next phase.
          </Body>
        </View>
      </SafeAreaView>
    </>
