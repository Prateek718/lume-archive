...
const s = StyleSheet.create({
  ...
  scanBadgeText: { fontSize: 13, color: Colors.gold, fontWeight: '600' },
  scanDate:   { marginLeft: 'auto', fontSize: 15, color: Colors.textSecondary },
  ...
  streakNum:   { fontFamily: Typography.serif, fontSize: 32, color: Colors.gold, lineHeight: 36 },
  streakLabel: { fontSize: 13, color: Colors.textSecondary },
  streakRight: { flex: 1 },
  streakBest:  { fontSize: 13, color: Colors.textSecondary, marginBottom: Spacing.xs },
  streakToday: { fontSize: 13, color: Colors.cream, marginBottom: Spacing.xs },
  ...
  periodLabel: { fontSize: 10, color: Colors.gold, letterSpacing: 1.5, textTransform: 'uppercase', marginBottom: Spacing.sm },
  ...
  checkmark:   { fontSize: 11, color: Colors.background, fontWeight: '700' },
  stepLabel:   { fontSize: 15, color: Colors.cream },
