...
// Editorial copy for the rescan delta screens (Issue Cover + Scan Delta).
// Generated by lib/gemini/delta.ts after Phase 2 settles on rescans.
// Optional + nullable: rescans render the delta UI even if generation fails.
export interface DeltaDekLine {
  number:   '01' | '02' | '03';
  headline: string;
  body:     string;
}
