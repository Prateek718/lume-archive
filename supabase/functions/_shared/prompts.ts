// Vision prompt + shared editorial constants. Mirrors the client-side
// originals at lib/gemini/shared.ts and lib/gemini/vision.ts. Phase XIII-a
// only moves the vision prompt; the five Flash prompts land in XIII-b.

import type { GeminiVisionRequest } from "./types.ts";
